...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown ml-1">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="#">View ECs</a>
    ...
    <div class="container mb-2">
      ...
      if ($result -> num_rows == 0) {
        ...
        echo "<tr><th scope=",'col',">Checkbox</th><th scope=",'col',">ID</th><th scope=",'col',">Module Name</th><th scope=",'col',">Extension Deadline</th><th scope=",'col',">Self Certified</th><th scope=",'col',">Status</th></tr>";
    ...
    <div id="OptionsBar" class="container">
      <div class="row">
        <div class="col">
          <form action="../pages/scripts/deleteEC.php" method="post" target="_self">
        ...
        <div class="col">
          <form action="" method="post">
              <button name="delete" type="submit" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                Delete
              </button>
            </form>
        </div>
